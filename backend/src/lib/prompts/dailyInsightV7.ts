// Daily Insight system prompt -- v7.
//
// Changes vs v6:
//   - specialActivity context: when a hiking (or other special activity) is present,
//     the AI may reference it in the context of nutrition, calorie needs, or recovery.
//     It must NOT be treated as regular training (dayType/workoutType).

export const DAILY_INSIGHT_PROMPT_VERSION = 'v7';
